...
try:
    ...
    logger.critical("Missing library 'pan-os-python'.")
    sys.exit(1)
...
# =========================================================
# >>> FIX: Added 'X-Requested-With' header to all requests below <<<
